...
{
    /// <summary>
    /// Contains target framework metadata needed for restore operation. Compared to IVsTargetFrameworkInfo2, this adds support for CentralPackageVersions and GlobalPackageVersions
    /// </summary>
    [ComImport]
    ...
    public interface IVsTargetFrameworkInfo3 : IVsTargetFrameworkInfo2
    {
        ...
        /// <summary>
        /// Collection of global package references.
        /// </summary>
